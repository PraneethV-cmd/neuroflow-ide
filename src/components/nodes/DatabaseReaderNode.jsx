...
function DatabaseReaderNode({ id, data }) {
    ...
    // Collapsed view when data is loaded
    if (isDataLoaded) {
        return (
                    ...
                    {previewData.headers.length > 0 && (
                        <div className="preview-container">
                            <div className="section-title">
                                Dataset Preview (showing {Math.min(5, previewData.rows.length)} of {previewData.rows.length} rows)
                                {data.isFiltered && (
                                    <span style={{
                                        fontSize: '0.75em',
                                        color: '#10b981',
                                        ...
                                        marginLeft: '8px',
                                        cursor: 'help'
                                    }} title={`Filtered from ${data.originalRowCount} rows`}>
            ...
            <div className="node-content">
                {allowConnection ? (
                    <div className="config-sections">
                        ...
                        {/* Step 2: Selection (only after successful connection) */}
                        {connectionStatus === 'success' && (
                            <div className="config-section active highlight">
                                ...
                                <div className="button-group-row">
                                    ...
                                    {previewData.headers.length > 0 && (
                                        <button
                                            className="btn primary flex-btn pulse"
                        ...
                        {previewData.headers.length > 0 && !isDataLoaded && (
                            <div className="preview-container">
                                <div className="preview-header-row">
                                    <div className="section-title">
                                        Data Preview (showing {Math.min(5, previewData.rows.length)} of {previewData.rows.length} rows)
                                        {data.isFiltered && (
                                            <span style={{
                                                fontSize: '0.75em',
                                                color: '#10b981',
                    ...
                    <div className="empty-state">
                        ...
                        <div className="empty-text">Please connect to a Start node to begin configuration</div>
                    </div>
                )}
            </div>
...
export default DatabaseReaderNode;
